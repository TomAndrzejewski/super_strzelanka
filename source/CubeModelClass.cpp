...
bool CubeModelClass::Initialize(ID3D11Device* device, ID3D11DeviceContext* deviceContext, WCHAR* textureFilename, char* modelFilename)
{
	bool result;
...
ID3D11ShaderResourceView* CubeModelClass::GetTexture()
{
...
bool CubeModelClass::LoadTexture(ID3D11Device* device, ID3D11DeviceContext* deviceContext, WCHAR* filename)
{
	bool result;
...
void CubeModelClass::ReleaseTexture()
{
