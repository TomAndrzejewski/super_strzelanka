...
bool MultiTextureModelClass::Initialize(ID3D11Device* device, char* modelFilename, WCHAR* textureFilename1, WCHAR* textureFilename2)
{
	bool result;
...
bool MultiTextureModelClass::LoadTextures(ID3D11Device* device, WCHAR* filename1, WCHAR* filename2)
{
	bool result;
...
bool MultiTextureModelClass::LoadModel(char* filename)
{
	ifstream fin;
	char input;
	int i;
